...
class Site extends React.Component {
  ...
  render() {
    ...
    let partIndex =
      this.props.PartIndex !== undefined && this.props.partIndex !== null
...
export default connect(mapStateToProps, mapDispacthToProps)(Site);
