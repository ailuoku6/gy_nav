...
// class HeadBar1 extends React.Component {
...
//     let headBase =
//       this.props.device !== 'phone' ? 'headBar headBarHoverbel' : 'headBar';
...
//                     key={JSON.stringify(item)}
//                     className={
//                       this.props.selectMcIndex === index ? 'selected' : ''
//                     }
//                     onClick={() => {
//                       // this.setState({
...
//               style={{
//                 width:
//                   this.refs.wrap && this.refs.searchBtn
//                     ? this.refs.wrap.clientWidth -
//                       this.refs.searchBtn.clientWidth
//                     : 0,
//               }}
//             >
...
//                     key={index}
//                     className={
//                       index === this.state.sugSelectIndex ? 'selected' : ''
//                     }
//                     style={{ textDecoration: 'none', cursor: 'pointer' }}
//                     onClick={() => {
//                       this.setState(
